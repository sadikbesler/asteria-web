/* Neva Güzellik — shared site behaviour (all pages) */
(function () {
  'use strict';

  var cfg = window.NEVA_CONFIG || {};
  var EN = window.NEVA_I18N_EN || {};
  ...
  function showDemoNotice() {
    ...
    try { if (sessionStorage.getItem('neva-demo-seen')) return; } catch (e) {}
    ...
    ok.addEventListener('click', function () {
      try { sessionStorage.setItem('neva-demo-seen', '1'); } catch (e) {}
      bar.remove();
  ...
  collect(document);
  var initial = 'tr';
  try { initial = new URLSearchParams(location.search).get('lang') || read('neva-lang') || 'tr'; } catch (e) {}
